...
import type { DiscountType, SubscriptionPlanOption } from "@/lib/api";
...
export function CouponFormModal({ open, onClose, plans, isSubmitting, onSubmit }: CouponFormModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={t("Create Coupon")}>
