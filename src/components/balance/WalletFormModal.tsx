...
// Deliberately just 3 fields (name, account number, opening balance) --
// unlike the full Chart of Accounts form (AccountFormModal), a Wallet is
// always a plain money-holding place. accountType/accountSubtype are set
// automatically (ASSET/"bank") rather than exposed as a choice here; the
// full Chart of Accounts at /accounts remains available for anyone who
