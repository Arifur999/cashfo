...
// Retired -- "Income Category" was merged with "Expense Category" into the
...
export default async function IncomePlanningPage({ searchParams }: PageProps<"/income-planning">) {
